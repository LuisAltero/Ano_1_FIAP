-- Na tabela “T_SLV_CATEGORIA”, crie a instrução SQL, comando DDL para 
...
-- Utilize o comando abaixo, para visualizar a alteração realizada.
...
-- Na tabela “T_SLV_AUTOR”, crie a instrução SQL, comando DDL para 
...
-- Na tabela “T_SLV_AUTOR_LIVRO”, crie a instrução SQL, comando DDL 
...
-- Na tabela “T_SLV_LIVRO”, crie a instrução SQL, comando DDL para alterar
...
-- Na tabela “T_SLV_AUTOR_LIVRO”, crie a instrução SQL, comando 
...
-- Na tabela “T_SLV_LIVRO”, crie a instrução SQL, comando DDL para 
...
-- Na tabela “T_SLV_CATEGORIA”, crie a instrução SQL, comando 
